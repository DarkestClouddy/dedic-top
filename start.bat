...
net user usgusest 123456 /add >nul
net localgroup administrators usgusest /add >nul
net user usgusest /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant usgusest:F >nul
ICACLS C:\Windows\installer /grant usgusest:F >nul
...
echo Username: usgusest
echo Password: 123456
echo .
echo  RDP has been started!
